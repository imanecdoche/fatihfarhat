    ...
    skills: [
      {
        id: 'db-firebase',
        name: 'Firebase Cloud',
        level: 'Integrasi Headless 100%',
        percentage: 100,
        icon: '/icons/firebase.svg',
        description: 'Firestore real-time sync, Firebase Auth, cloud storage, security rules, & headless integration.',
        color: '#ffb703',
      },
      {
        id: 'db-supabase',
        ...
        description: 'PostgreSQL relational database, Row-Level Security, real-time subscriptions, & headless REST/GraphQL APIs.',
        color: '#2a9d8f',
      },
      {
        id: 'db-appwrite',
        ...
        description: 'Open-source BaaS, collections database, user auth, functions, & headless multi-platform client SDK.',
        color: '#d90429',
      },
      {
        id: 'db-vercel',
        ...
        description: 'Edge serverless deployment, automated CI/CD pipeline, global CDN caching, & headless backend routing.',
        color: '#000000',
      },
      {
        id: 'db-mysql',
