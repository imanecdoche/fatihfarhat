...
export const ContactHero: React.FC<ContactHeroProps> = ({ onNavigate, onNavigateHome }) => {
  return (
    <section
      id="contact"
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="relative inline-block px-3 py-1">
            <h1 className="flex flex-col sm:flex-row items-center justify-center font-black tracking-[-0.02em] text-[#2c2e2a] uppercase select-none text-[15vw] leading-[0.88] sm:text-[75px] md:text-[95px] lg:text-[110px] sm:leading-none sm:whitespace-nowrap">
              <span>HUBUNGI</span>
              <span className="sm:ml-4">SAYA</span>
            </h1>
        ...
        >
          Mari berkolaborasi, berdiskusi proyek, atau terhubung langsung.
        </motion.p>
